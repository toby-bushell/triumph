...
<div id="buddypress">
<?php dynamic_sidebar('login_widget');?>
	<?php
...
<!-- 			<p><?php _e( 'Registering for this Triumph Members Site is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time.' ); ?></p>
 -->
			<?php
